...
<div className='text-white grid grid-cols-2 p-20 gap-9'>
  ...
  <h1 className='m-4'>Developed a responsive e-commerce website using React,
     ...
     <span> 2. EVENTS MANAGEMENT APP
     <h2 className='m-4'>Collaborated with a team of Web Developers to 
      create a responsive Events Management Web App with React, where events organizers
       could register their events and users could also search for Events of all kinds.
     </h2>
     </span>
     <span> 3. LYNN'S BRIDAL WEBSITE
      <h4 className='m-4'>
