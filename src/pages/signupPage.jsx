      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="bg-[#12071F] w-[65rem] h-[35rem] p-8 rounded-lg shadow-lg text-center">
          ...
          <div className="relative w-1/2">
              ...
              <img src={lejedLogo} alt="logo" className='w-32 h-24'/>
            ...
            <img src={fieldImage} alt="FieldImage" className="w-full h-full object-cover opacity-70" />
              ...
              <div className="absolute h-[30rem] w-80 bg-[#F5F1EA] top-1 backdrop-blur-lg bg-opacity-50 rounded-lg border border-[#FFCD58] p-4">
                <SignupForm />
